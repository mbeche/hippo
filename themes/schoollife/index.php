...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href='<?php echo get_bloginfo('template_directory'); ?>/my-style.css'>
        <title>Mellanie's Blog</title>
    </head>
    <body>
      <div class="disclaimer">
        This site/theme is a demo. <br>
        <a href='<?php echo get_bloginfo('template_directory'); ?>/img/SchoolLife_Single.png'>Click here</a> to view PSD capture I am emulating.
      </div>
      <div class="content">
        <div class="title">
  				<a href="#"><div id="com">.com</div>
  				<span id="school-life">school life</span></a>
  			</div>
      ...
      <div class="menu" id="full">
        ...
        <div class="sidebar">
          ...
          <div class="recent-posts">
            ...
            <hr>
            <div class="post">Mellanie’s Intro (movie)
              <br><span class="post-author"><em>by</em> Author Name </span><span class="date">posted on December 15, 2011</span>
            </div>
            <hr>
            <div class="post">Greetings from just up the road
              <br><span class="date">posted on December 15, 2011</span>
